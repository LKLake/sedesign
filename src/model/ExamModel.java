...
public class ExamModel {
    ...
    public ExamModel(){}
    public ExamModel(Paper paper,Map<Integer,String>myAnswer,int score,int singleScore,int multiScore){
        this.paper=paper;
        this.id=0;
    ...
    public ExamModel(Paper paper,Map<Integer,String>myAnswer){
        this.paper=paper;
        this.id=0;
        this.myAnswer=myAnswer;
        this.addedTime=new Date();
